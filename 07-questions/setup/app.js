...
for (let i=0; i < questions.length; i++) { openClose(questions[i]); }
...
function openClose(question) {
    ...
    btn.addEventListener("click", function() {
        // Cycle through the questions and if the current
        // question is not the one that we clicked on,
        // remove the show-text style
